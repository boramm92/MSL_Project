var audioRecordViewScript4Oper = (function() {
	// 프로젝트 기본정보는 mProjectInfo 객체에서 전역으로 사용한다.
	
	var $mP;
	var requestApi = {
		selectProjectList: "/oper/project/selectProjectList.json",
		selectConfirmList: "/oper/sound/record/selectConfirmWorkData.json",
		goDashboard: "/oper/project/projectList.do",
		preview: "/oper/sound/record/preview.json",
		download: "/oper/sound/record/downloadRecordData.json"
	};
	var mProjectInfo = {}; 
