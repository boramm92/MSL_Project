...
// 프로젝트 기본정보는 mProjectInfo 객체에서 전역으로 사용한다.
	var $mP;
	var $voiceHandler;
	var mainURL = "/oper/project";
	var specURL = "/oper/sound/listen";
	
	var requestApi = {
		selectProjectList: 	mainURL+"/selectProjectList.json",
		selectConfirmList:	specURL+"/selectConfirmWorkData.json",
		goDashboard: 		mainURL+"/projectList.do",
		preview: 			specURL+"/preview.json",
		download: 			specURL+"/downloadOrgData.json"
	};
	var mProjectInfo = {}; 
