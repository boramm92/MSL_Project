...
var audioSplitViewScript4Oper = (function() {
    ...
    function bindEventHandler() {
        ...
        $("button.btnPost", $mP).on("click", moveProjectState);
    ...
    function postProject() {
        ...
        // var param =  $("form[name=form-project]", $mP).formJson();
        VoiceJS.postProject(mProjectInfo, moveProjectListPage);
    }
    ...
    function stopProject() {
        // var param =  {projectId: mProjectInfo.projectId};
        VoiceJS.stopProject(mProjectInfo, moveProjectListPage);
    }
