var textSentenceViewScript4Oper =  (function() {
	var $mP;
	...
	function fileUpload() {
		...
		TextJS.jobFileUpload(param, $("input[name=findFile]"), uploadResult);
	}
	// 파일삭제
	...
	function moveProjectState() {
		MindsJS.movePage("/oper/text/"+mProjectInfo.projectId+"/showProjectStateView.do");
	}
	// 뒤로가기 버튼 눌렀을 때
