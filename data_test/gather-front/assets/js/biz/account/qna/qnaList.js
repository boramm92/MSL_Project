var qnaScript = (function() {
	...
	var requestApi = {
		selectQnAList: "/profile/selectQnAList.json" ,
		selectPostingList: 	"/wspace/selectPostingList.json", // 프로젝트 목록
		moveRegistView: "/profile/registQnA.do"
	};
	...
	function renderQnAList(data) {
		...
		var $list = $("#myList", $mP).html(myCardHtml);
		if(data != null && data.length > 0) {
	...
	function showDetail() {
		...
		MindsJS.movePage("/profile/"+qnaid+"/viewQnA.do");
	}
