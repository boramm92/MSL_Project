var textClueViewScript = (function() {
	...
	function bindEventHandler() {
		...
		/*$(document).on("keydown", function(event) {
			...
			if(key == 107) {
				if($("#question_modal", $mP).css("display") == 'block') {
				} else {
	...
	function showModalAddQuestion() {
		...
		$modal = $mP.regQuestModal(settings);
		$modal.show();
	}
	...
	function chooseSentenceEventHandler(contentId, param) {
		...
		qaTemp.reason_start_index 	= param.reason_start_index ? param.reason_start_index : qaTemp.reason_start_index;
		qaTemp.reason_end_index 	= param.reason_end_index ? param.reason_end_index : qaTemp.reason_end_index;
		qaTemp.reason_morpheme 		= param.reason_morpheme ? param.reason_morpheme : qaTemp.reason_morpheme;
