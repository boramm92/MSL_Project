	...
	function CreateUiHandler($this, settings) {
		...
		function setNewsList(data, selectNewsData) {
			if(data != null) {
				...
				if(mainText != null) {
					mainText = mainText.replace('기사', '<em>기사</em>');
					mainText = mainText.replace('그림', '<em>그림</em>');
					mainText = mainText.replace('사진', '<em>사진</em>');
					mainText = mainText.replace('기자', '<em>기자</em>');
					mainText = mainText.replace('관련기사', '<em>관련기사</em>');
					mainText = mainText.replace('편집자주', '<em>편집자주</em>');
				}
