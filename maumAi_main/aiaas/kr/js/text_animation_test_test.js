...
function sectionFigureAni(){
    ...
    // AICC 영역
    if(direction == 1 && !aiccVisible && aiccPosY < viewportHalfHeight){
        console.log('aicc');
        $('.stn').removeClass('on');
    ...
    if(direction == -1 && !aiccVisible && aiccPosY < viewportHalfHeight){
        ...
        new numberCounter('.aicc_fgr05', 2300000); 
        aiccVisible = true;    
    }else if(direction == -1 && !aiccVisible && aiccPosY < viewportHalfHeight){
        $('.stn').removeClass('on');
        aiccVisible = false;  
    }
    ...
    // smart X 영역
    if(direction == 1 && !smartxVisible && smartxPosY < viewportHalfHeight){
        aiccVisible = false;
        console.log('smartX');
        ...
        smartxVisible = true;        
    }else if(direction == 1 && smartxPosY < 0){
        smartxVisible = false;  
    }

    if(direction == -1 && !smartxVisible && (smartxPosY - 288) < viewportHalfHeight){
        console.log('smartX');
    ...
    // maum minutes 영역
    if(direction == 1 && !minutesVisible && minutesPosY < viewportHalfHeight){
        console.log('minutes');
        ...
        minutesVisible = true;       
    }else if(direction == 1 && minutesPosY < 0){
        minutesVisible = false;  
    }

    if(direction == -1 && !minutesVisible && (minutesPosY - 288) < viewportHalfHeight){
        console.log('minutes');
    ...
    // cloud API 영역
    if(direction == 1 && !cloudApiVisible && cloudApiPosY < viewportHalfHeight){
    ...
    }else if(direction == 1 && cloudApiPosY < 0){
        cloudApiVisible = false;  
    }

    if(direction == -1 && !cloudApiVisible && (cloudApiPosY - 288) < viewportHalfHeight){
        console.log('cloudApi');
    ...
    // maum DATA 영역
    if(direction == 1 && !maumDataVisible && maumDataPosY < viewportHalfHeight){
    ...
    }else if(direction == 1 && maumDataPosY < 0){
        maumDataVisible = false;  
    }

    if(direction == -1 && !maumDataVisible && (maumDataPosY - 288) < viewportHalfHeight){
        console.log('maumData');
    ...
    //     $('.stn.aicc').getBoundingClientRect();
...
function checkVisible(elm, eval) {
    ...
    var viewportHalfHeight = $(window).height() / 2,
        ...
        // RectY = $(elm).getBoundingClientRect();
